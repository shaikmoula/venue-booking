                    ...
                    <table bgcolor="#FFD8AF" width="560" height="310"  border="">
                        ...
                        <%
                            ...
                            while (rs.next()) {
                                s2 = rs.getString("vname");
                        %>
                        <tr  align="center"><td><input type="radio" name="vname" value="<%=s2%>"/></td><td><%=s2%></td></tr>
                        <%
                                    }
                        ...
                        %>
                        <tr><td align="center" colspan="2"><a href="vlogin.jsp">To Book Online Log In Here</a></td></tr>
                        <tr><td align="center" colspan="2"><a href="searchvenuevt.jsp">Back</a></td></tr>
                    </table>
                    <br/>
                </div>
            </div>
