...
<%
String s2=(String)request.getParameter("vname");
 %>
	...
	<tr ><td align="center">Venue Name</td><td><input type="text" name="vname" value="<%=s2%>" readonly="readonly"/></td></tr>
	<tr><td align="center">From Date</td><td><input type="text" name="fdate"/>	(Ex:2018-01-19)</td></tr>
	<tr><td align="center">To Date</td><td><input type="text" name="tdate"/>	(Ex:2018-01-19)</td></tr>
